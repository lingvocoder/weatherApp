class WeatherApp {
                    ...
                    <div class="weather__inner">
                        <div class="weather__container">
                            <div class="weather__header">
                                ...
                                <span class="weather__text">Moscow, RU</span>
                            ...
                            <main class="weather-content">
                                <div class="weather-content__inner">
                                    <div class="weather-content__row weather-content__row_main">
                                        <span class="weather-content__elem weather-content__elem_icon">
                                            <i class="wi wi-des weather-content__icon weather-content__icon_main"></i>
                                        </span>
                                        <span class="weather-content__elem weather-content__elem_des"></span>
                                        <span class="weather-content__elem weather-content__elem_deg"></span>
                                    </div>
                                    <div class="weather-content__row weather-content__row_supp">
                            ...
                            <div class="menu">
                                <div class="menu__wrapper">
                                    <div class="menu__inner">
                                        <div class="weather__header">
                                            <span class="weather__text">Settings</span>
    ...
    displayLocation = (city, country) => {
        let node = document.querySelector(".weather__text");
        node.textContent = `${city}, ${country}`;
    }

    setTemperature = (temperature) => {
        const node = document.querySelector(".weather-content__elem_deg");
    ...
    setIconCode = (icon, id) => {
        const node = document.querySelector(".wi.weather-content__icon_main");
        if (icon === undefined) {
    ...
    setDescription = (des, feels) => {
        let description = document.querySelector(".weather-content__elem_des");
        let na = document.createElement("i");
        na.classList.add("wi", "wi-na");
